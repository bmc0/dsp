...
LADSPA_DSP_CFLAGS   := ${DEPFLAGS} ${BASE_CFLAGS} -fPIC -DPIC -D__LADSPA_FRONTEND__ -D__SYMMETRIC_IO__ ${LADSPA_DSP_EXTRA_CFLAGS} ${CFLAGS}
LADSPA_DSP_CXXFLAGS := ${DEPFLAGS} ${BASE_CXXFLAGS} -fPIC -DPIC -D__LADSPA_FRONTEND__ -D__SYMMETRIC_IO__ ${LADSPA_DSP_EXTRA_CFLAGS} ${CXXFLAGS}
